    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='quality_rec_entity_5e3617_idx'), models.Index(fields=['entity', 'date'], name='quality_rec_entity_78b863_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='quality_record_entity_code')],
            },
        ),
    ]
