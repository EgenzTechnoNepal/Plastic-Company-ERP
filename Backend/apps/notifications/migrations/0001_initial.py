    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='notificatio_entity_a2bac7_idx'), models.Index(fields=['entity', 'date'], name='notificatio_entity_a5f574_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='notifications_record_entity_code')],
            },
        ),
    ]
