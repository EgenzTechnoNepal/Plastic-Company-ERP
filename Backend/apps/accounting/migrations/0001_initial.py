    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='accounting__entity_70c947_idx'), models.Index(fields=['entity', 'date'], name='accounting__entity_347962_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='accounting_record_entity_code')],
            },
        ),
    ]
