    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='inventory_r_entity_358baf_idx'), models.Index(fields=['entity', 'date'], name='inventory_r_entity_cfae44_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='inventory_record_entity_code')],
            },
        ),
    ]
