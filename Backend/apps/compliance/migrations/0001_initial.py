    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='compliance__entity_f15618_idx'), models.Index(fields=['entity', 'date'], name='compliance__entity_07e631_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='compliance_record_entity_code')],
            },
        ),
    ]
