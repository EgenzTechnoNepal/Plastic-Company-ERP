    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='analytics_r_entity_201b62_idx'), models.Index(fields=['entity', 'date'], name='analytics_r_entity_66530c_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='analytics_record_entity_code')],
            },
        ),
    ]
