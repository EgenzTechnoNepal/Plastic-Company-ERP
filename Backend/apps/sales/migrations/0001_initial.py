    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='sales_recor_entity_4bc933_idx'), models.Index(fields=['entity', 'date'], name='sales_recor_entity_0e5242_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='sales_record_entity_code')],
            },
        ),
    ]
