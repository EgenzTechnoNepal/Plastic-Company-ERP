    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='payroll_rec_entity_ded29b_idx'), models.Index(fields=['entity', 'date'], name='payroll_rec_entity_03e255_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='payroll_record_entity_code')],
            },
        ),
    ]
