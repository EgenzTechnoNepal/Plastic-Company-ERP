    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='hr_record_entity_6cc88e_idx'), models.Index(fields=['entity', 'date'], name='hr_record_entity_04a20d_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='hr_record_entity_code')],
            },
        ),
    ]
