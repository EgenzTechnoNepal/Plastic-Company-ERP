    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='warehouse_r_entity_56fe21_idx'), models.Index(fields=['entity', 'date'], name='warehouse_r_entity_47ee0f_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='warehouse_record_entity_code')],
            },
        ),
    ]
