    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='procurement_entity_3ca12e_idx'), models.Index(fields=['entity', 'date'], name='procurement_entity_e5d71d_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='procurement_record_entity_code')],
            },
        ),
    ]
