    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='workflow_re_entity_0aa062_idx'), models.Index(fields=['entity', 'date'], name='workflow_re_entity_2b5e09_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='workflow_record_entity_code')],
            },
        ),
    ]
