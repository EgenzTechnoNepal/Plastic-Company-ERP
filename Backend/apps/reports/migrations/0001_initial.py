    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='reports_rec_entity_0da89f_idx'), models.Index(fields=['entity', 'date'], name='reports_rec_entity_ffe9c2_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='reports_record_entity_code')],
            },
        ),
    ]
