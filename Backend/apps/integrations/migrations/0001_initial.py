    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='integration_entity_a365b9_idx'), models.Index(fields=['entity', 'date'], name='integration_entity_959be5_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='integrations_record_entity_code')],
            },
        ),
    ]
