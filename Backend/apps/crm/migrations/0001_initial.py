    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='crm_record_entity_8133f7_idx'), models.Index(fields=['entity', 'date'], name='crm_record_entity_a48e91_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='crm_record_entity_code')],
            },
        ),
    ]
