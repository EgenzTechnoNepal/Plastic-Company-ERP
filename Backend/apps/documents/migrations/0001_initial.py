    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['entity', 'status'], name='documents_r_entity_a4c563_idx'), models.Index(fields=['entity', 'date'], name='documents_r_entity_1c1581_idx')],
                'constraints': [models.UniqueConstraint(fields=('entity', 'code'), name='documents_record_entity_code')],
            },
        ),
    ]
